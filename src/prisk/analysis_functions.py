...
def model_dependence(plot=False):
    ...
    clayton_copula_models, clayton_error_basins, dependence_matrix = calculate_basin_copula_pairs(uniform_marginals, plot_dependence_matrix=plot)
    ...
    return clayton_copula_models, ordered_basins, basin_timeseries
